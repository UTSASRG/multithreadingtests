...
CornerPtr	Faces_Corner_Begin (FacePtr pF)
{
	...
	return (CornerPtr)(RetrieveListItem(FCL_Last_Accessed, umCORNER, FCL_Index_Last_Accessed) );
}
...
FacePtr Corners_Face_Begin (CornerPtr pC)
{
	...
	return (FacePtr)(RetrieveListItem(CFL_Last_Accessed, umFACE, CFL_Index_Last_Accessed) );
}
