...
public:
	...
	SOLIDS_FLUIDS_EXAMPLE()
		: initial_time (0),
		  ...
		  write_output_files (true), write_substeps (false), write_last_frame (true), write_time (false), write_frame_title (false), output_directory ("output"), data_directory ("../../datasets/facesim"),
