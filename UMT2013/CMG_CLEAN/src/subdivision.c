...
void hexIntoPyr(Subdivision *thissss, int *nodeIdList) {
    /*----------------------------------------------------------------------
...
/*----------------------------------------------- calculate the centroid*/
  Position centroid;
  int newNode = thissss->subNodesStart+0;
  ...
  */
  ...
  /*WIN Store at the place where our sub-nodes start, thissss is the only sub-
    node created */
...
/* ------------------------------------ store the new pyramid zone lists,
  ...
  SetZoneDummy(thissss->subZonesStart + 0, newZone);

  ZoneInit(&newZone, n1, n5, n6, n2, newNode, 0, 0, 0);
  SetZoneDummy(thissss->subZonesStart + 1, newZone);

  ZoneInit(&newZone, n1, n4, n8, n5, newNode, 0, 0, 0);
  SetZoneDummy(thissss->subZonesStart + 2, newZone);

  ZoneInit(&newZone, n2, n6, n7, n3, newNode, 0, 0, 0);
  SetZoneDummy(thissss->subZonesStart + 3, newZone);

  ZoneInit(&newZone, n3, n7, n8, n4, newNode, 0, 0, 0);
  SetZoneDummy(thissss->subZonesStart + 4, newZone);

  ZoneInit(&newZone, n5, n8, n7, n6, newNode, 0, 0, 0);
  SetZoneDummy(thissss->subZonesStart + 5, newZone);
...
void hexIntoPriAndPyr(Subdivision *thissss, int *nodeIdList) {
...
*/
  ...
  */
  ...
  int newNode1 = thissss->subNodesStart+0;
  int newNode2 = thissss->subNodesStart+1;
...
*/
void priIntoPyrAndTet(Subdivision *thissss, int *nodeIdList) {
...
*/
void priIntoPriAndTet(Subdivision *thissss, int *nodeIdList) {
  int n1=nodeIdList[0],n2=nodeIdList[1],n3=nodeIdList[2],n4=nodeIdList[3],n5=nodeIdList[4],n6=nodeIdList[5];
...
*/
void pyrIntoPyrAndTet(Subdivision *thissss, int *nodeIdList) {
...
void hexIntoHexAndPri(Subdivision *thissss, int *nodeIdList) {
  fprintf(stderr, "Not implemented");
  assert(0);
}
void hexIntoHex(Subdivision *thissss, int *nodeIdList){
  fprintf(stderr, "Not implemented");
  assert(0);
}
void priIntoPri(Subdivision *thissss, int *nodeIdList){
  fprintf(stderr, "Not implemented");
  assert(0);
}
void pyrIntoPriAndPyrAndTet(Subdivision *thissss, int *nodeIdList){
  fprintf(stderr, "Not implemented");
  assert(0);
}
void pyrIntoHexAndPyr(Subdivision *thissss, int *nodeIdList){
  fprintf(stderr, "Not implemented");
  assert(0);
}
