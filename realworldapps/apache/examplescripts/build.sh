...
./configure --prefix=$APACHE_BENCHMARK_ROOT_DIR/src/install/$1 >> "$BUILD_LOG_FOLDER/apacheconfigure_$BUILD_TIMESTAMP.log" 2>> "$BUILD_LOG_FOLDER/apacheconfigure_$BUILD_TIMESTAMP.err"
