...
#all_benchmarks = ['bodytrack', 'canneal', 'blackscholes','dedup', 'facesim', 'ferret','freqmine', 'fluidanimate', 'streamcluster', 'swaptions', 'x264']
all_benchmarks = ['dedup','blackscholes']
all_configs = ['pthread']
runs = 1
